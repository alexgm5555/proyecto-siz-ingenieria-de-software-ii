...
<br/><br/><table width="796" border="0" align="center" background="images/Bello Verde_800.jpg"   bgcolor="#FFFFFF" >
  ...
  <tr>
    <td width="790" height="139" colspan="2"><div align="center">
        <div align="right"><a href="index.php" title="Iniciar Sesión" target="_self">Volver al Inicio</a></div><img src="images/images.jpg?q=tbn:ANd9GcSRJ_TeKNnn8Gn_EcTop6MJ0j57XOqV7kjY6Yd62StcrPukKOmc" alt="IMAGEN" width="152" height="108" align="middle"/></div></td>
  </tr>
  <tr>
            ...
            <td width="383" height="226"><fieldset>
              ...
              <table width="348" border="0" align="center" bgcolor="#FFFFFF">
                ...
                <tr>
                  ...
                  <td><span class="Estilo14">Contrase&ntilde;a:
                    <label> </label>
                    </span>
                      <label><br/>
                      <input name="contrasena" type="password" maxlength="16" tabindex="2" />
                    </label></td>
                </tr>
                <tr>
