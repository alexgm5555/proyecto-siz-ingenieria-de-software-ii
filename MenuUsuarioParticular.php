...
<title>Zoonosis -  pagina de bienvenida Usuario</title>
...
<br/><br/><table width="796" border="0" align="center" background="images/Bello Verde_800.jpg"   bgcolor="#FFFFFF" > 
  ...
  <tr>
    <td height="76" colspan="2"><div align="center">
      <p class="Estilo3 Estilo19">Menu Usuario</p>
</div></td>
  </tr>
  <tr>
        ...
        <table width="444" height="373" border="0" align="center" >
          <tr>
            <td width="647" height="226"><fieldset>
              <legend class="Estilo18">Menu de Usuario<br/>
              </legend>
              <table width="347" height="341" border="0" align="center" bgcolor="">
                ...
                <tr>
                <td height="64"><div align="center"><a href="BuscarMascota.php"><img src="images/gato4.jpg" alt="usuario" width="70" height="70" /></a></div></td>
                  <td><span class="Estilo15"><a href="BuscarMascota.php" class="Estilo15">Buscar Mascota</a>
                      <label></label>
                  </span>
                    <label><br/>
                </label>
                  <label for="Raza2"></label></tr>
