...
<div id="nav">
             ...
             <div align="right">Usuario Activo: <?php echo
...
<div id="box1">
       ...
       <table width="100%" height="244" cellpadding="1" cellspacing="0">
                       ...
                       <th width="34%" scope="col">
                               <h6 align="center"><span class="sectionList"><?php echo
$f['Nombre'];?></span> </h6>
                               <h6 align="center">
                               <?php
                               ...
                               <h6 align="center"><span class="sectionList">Codigo:
<?php echo $f['idAnimal'];?> </span> </h6>
                               <h5 align="center">&nbsp;</h5>
...
<?php echo $f['TipoAnimal'];?></h5>
           ...
           <p align="center"><span class="login">Habilidad: <?php echo
$f['Habilidad'];?></span></p>
                                         <p>
...
<div class="AccordionPanelTab">Listado de Solicitudes de Adopción</div>
                           <div class="AccordionPanelContent">
                             <div align="center">
                               <p>Por favor ingrese la información de
la Nueva Sede:</p>
                           ...
                           #ciclo para mostrar todos los registros de este usuario
                                                               ...
                                                               ?>
                                       <tr>
                                         <th scope="col"> <table width="100%" height="120"
border="0">
                                           <tr>
...
name="login" value="Modificar" class="inputButton" />
                         ...
                         <div class="AccordionPanel">
                           <div class="AccordionPanelTab">Eliminar
Registro</div>
                           <div class="AccordionPanelContent">

                             <p align="center">&nbsp;</p>
                             <form id="form3" method="post"
action="EliminarRegistroUsuario.php"><input name="idanimal"
type="hidden" value="<?php echo $f['idAnimal'];?>" />
                               <div align="center">
                                 <table width="100" border="0">
                                   <tr>
                                     <td><input type="submit"
name="login3" value="Eliminar Registro" class="inputButton" /></td>
                                   </tr>
                                 </table>
                               </div>
                               <p align="center">&nbsp;</p>
                             ...
                             <p></p>
                               ...
                               <div id="sidebar">
                                 ...
                                 <div class="form">
                                   <p><?php echo $_SESSION['usuario'];?>, puedes realizar las
siguientes actividades</p>
                   <ol>

                     <li><a href="ClasificadorRoles.php">Pagina Inicio</a></li>
                     <li><a href="RegistrarMascota.php">Registrar
Mascotas</a></li>
                       <li><a href="BuscarMascota.php">Buscar Mascotas</a></li>
                       <li><a
href="MascotasRegistradas.php">Administrar Animales
Registrados</a></li>
                   </ol>
                 </div>
                                 <h3>Enlaces de Interés</h3>
                                       <ul class="linkedList">
                                               <li class="first">
                                                       <a href="http://www.freewebtemplates.com/free-templates/">Templates
Gratis</a>
                                               </li>
                                               <li>
